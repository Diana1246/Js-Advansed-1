const galleryItems = [
  ...
  const lightboxCloseButtonRef = document.querySelector('[data-action="close-lightbox"]');
  
  
  const createGalleryItemMarkup = (item) => {
    return `
  ...
  lightboxCloseButtonRef.addEventListener('click', closeLightbox);
